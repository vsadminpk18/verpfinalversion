...
from verp.controllers.item_variant import (create_variant, ItemVariantExistsError,
	InvalidItemAttributeValueError, get_variant)
from verp.stock.doctype.item.item import StockExistsForTemplate, InvalidBarcode
from verp.stock.doctype.item.item import (get_uom_conv_factor, get_item_attribute,
...
from verp.tests.utils import change_settings
...
class TestItem(unittest.TestCase):
	...
	def test_index_creation(self):
		...
		from verp.stock.doctype.item.item import on_doctype_update
		on_doctype_update()
