...
from verp.stock.doctype.serial_no.serial_no import SerialNoDuplicateError
...
from verp.stock.stock_ledger import SerialNoExistsInFutureTransaction
...
class TestPurchaseReceipt(unittest.TestCase):
	...
	def test_subcontracting_over_receipt(self):
		...
		"""
		from verp.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
		from verp.buying.doctype.purchase_order.test_purchase_order import (update_backflush_based_on,
	...
	def test_closed_purchase_receipt(self):
		from verp.stock.doctype.purchase_receipt.purchase_receipt import update_purchase_receipt_status
	...
	def test_pr_billing_status(self):
		...
		from verp.buying.doctype.purchase_order.purchase_order \
	...
	def test_make_purchase_invoice_from_pr_for_returned_qty(self):
		from verp.buying.doctype.purchase_order.test_purchase_order import create_purchase_order, create_pr_against_po
	...
	def test_subcontracted_pr_for_multi_transfer_batches(self):
		from verp.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
		from verp.buying.doctype.purchase_order.purchase_order import make_rm_stock_entry, make_purchase_receipt
		from verp.buying.doctype.purchase_order.test_purchase_order import (update_backflush_based_on,
	...
	def test_po_to_pi_and_po_to_pr_worflow_full(self):
		...
		"""
		from verp.buying.doctype.purchase_order import test_purchase_order
	...
	def test_purchase_receipt_with_exchange_rate_difference(self):
		from verp.accounts.doctype.purchase_invoice.test_purchase_invoice import make_purchase_invoice as create_purchase_invoice
		from verp.accounts.doctype.purchase_invoice.purchase_invoice import make_purchase_receipt as create_purchase_receipt
