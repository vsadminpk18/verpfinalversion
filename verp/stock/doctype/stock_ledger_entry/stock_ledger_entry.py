...
class StockLedgerEntry(Document):
	...
	def validate(self):
		...
		from verp.stock.utils import validate_warehouse_company, validate_disabled_warehouse
	...
	def on_submit(self):
		...
		if not self.get("via_landed_cost_voucher"):
			from verp.stock.doctype.serial_no.serial_no import process_serial_no
