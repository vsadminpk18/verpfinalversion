...
from verp.stock.doctype.delivery_note.delivery_note import make_sales_invoice, make_delivery_trip
from verp.stock.doctype.stock_entry.test_stock_entry \
	import make_stock_entry, make_serialized_item, get_qty_after_transaction
from verp.stock.doctype.serial_no.serial_no import get_serial_nos, SerialNoWarehouseError
from verp.stock.doctype.stock_reconciliation.test_stock_reconciliation \
	import create_stock_reconciliation, set_valuation_method
from verp.selling.doctype.sales_order.test_sales_order import make_sales_order, create_dn_against_so
...
class TestDeliveryNote(unittest.TestCase):
	...
	def test_dn_billing_status_case3(self):
		...
		from verp.selling.doctype.sales_order.sales_order \
