...
from verp.stock.doctype.stock_reconciliation.test_stock_reconciliation import create_stock_reconciliation
from verp.stock.doctype.item.test_item import set_item_variant_settings, make_item_variant, create_item
...
from verp.stock.doctype.stock_entry.stock_entry import move_sample_to_retention_warehouse, make_stock_in_entry
...
class TestStockEntry(unittest.TestCase):
	...
	def test_work_order(self):
		from verp.manufacturing.doctype.work_order.work_order \
