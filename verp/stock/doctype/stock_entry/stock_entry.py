...
from verp.stock.stock_ledger import get_previous_sle, NegativeStockError, get_valuation_rate
from verp.stock.get_item_details import get_bin_details, get_default_cost_center, get_conversion_factor, get_reserved_qty_for_so
...
from verp.stock.doctype.batch.batch import get_batch_no, set_batch_nos, get_batch_qty
from verp.stock.doctype.item.item import get_item_defaults
from verp.manufacturing.doctype.bom.bom import validate_bom_no, add_additional_cost
from verp.stock.utils import get_bin
from frappe.model.mapper import get_mapped_doc
from verp.stock.doctype.serial_no.serial_no import update_serial_nos_after_submit, get_serial_nos
from verp.stock.doctype.stock_reconciliation.stock_reconciliation import OpeningEntryAccountError
		...
		for d in self.get('items'):
			...
			if not d.basic_rate and not d.allow_zero_valuation_rate:
				d.basic_rate = get_valuation_rate(d.item_code, d.t_warehouse,
					...
					currency=verp.get_company_currency(self.company), company=self.company,
