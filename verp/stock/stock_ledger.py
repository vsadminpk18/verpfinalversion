...
from verp.stock.utils import get_valuation_method, get_incoming_outgoing_rate_for_cancel
...
def make_sl_entries(sl_entries, allow_negative_stock=False, via_landed_cost_voucher=False):
	...
	if sl_entries:
		from verp.stock.utils import update_bin
	...
	def get_incoming_outgoing_rate_from_transaction(self, sle):
		...
		# Sales and Purchase Return
			...
			if frappe.get_cached_value(sle.voucher_type, sle.voucher_no, "is_return"):
				from verp.controllers.sales_and_purchase_return import get_rate_for_return # don't move this import to top
