...
from verp.accounts.party import validate_party_accounts, get_dashboard_info, get_timeline_data # keep this
			...
			if supplier:
				try:
					...
					if args.get('supplier_email_' + str(i)):
						from verp.selling.doctype.customer.customer import create_contact
