...
frappe.ui.form.on("Request for Quotation",{
	setup: function(frm) {
		...
		frm.fields_dict["suppliers"].grid.get_field("contact").get_query = function(doc, cdt, cdn) {
			...
			return {
				query: "verp.buying.doctype.request_for_quotation.request_for_quotation.get_supplier_contacts",
		...
		if (frm.doc.docstatus === 1) {
			...
			frm.add_custom_button(__('Download PDF'), () => {
				...
				frappe.prompt(fields, data => {
					...
					var w = window.open(
						frappe.urllib.get_full_url("/api/method/verp.buying.doctype.request_for_quotation.request_for_quotation.get_pdf?"
...
verp.buying.RequestforQuotationController = class RequestforQuotationController extends verp.buying.BuyingController {
	refresh() {
		var me = this;
		super.refresh();
