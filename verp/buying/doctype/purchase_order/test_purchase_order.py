...
from verp.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_invoice as make_pi_from_pr
...
class TestPurchaseOrder(unittest.TestCase):
	...
	def test_return_against_purchase_order(self):
		...
		from verp.stock.doctype.purchase_receipt.test_purchase_receipt \
				import make_purchase_receipt as make_purchase_receipt_return
		from verp.accounts.doctype.purchase_invoice.test_purchase_invoice \
