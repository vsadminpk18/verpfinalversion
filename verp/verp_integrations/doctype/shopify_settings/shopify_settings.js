...
frappe.provide("verp_integrations.shopify_settings");

frappe.ui.form.on("Shopify Settings", "onload", function(frm){
	frappe.call({
		method:"verp.verp_integrations.doctype.shopify_settings.shopify_settings.get_series",
		callback:function(r){
	...
	verp_integrations.shopify_settings.setup_queries(frm);
})
...
$.extend(verp_integrations.shopify_settings, {
