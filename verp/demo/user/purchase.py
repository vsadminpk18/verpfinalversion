...
import frappe, random, json, verp
...
from verp.stock.doctype.material_request.material_request import make_request_for_quotation
...
def work():
	...
	company_currency = frappe.get_cached_value('Company', verp.get_default_company(), "default_currency")
	party_account_currency = get_party_account_currency("Supplier", supplier, verp.get_default_company())
	...
	if random.random() < 0.5:
		from verp.stock.doctype.material_request.material_request import make_supplier_quotation
