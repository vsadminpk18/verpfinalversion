...
from verp.projects.doctype.timesheet.timesheet import make_salary_slip, make_sales_invoice
from frappe.utils.make_random import get_random
from verp.hr.doctype.expense_claim.test_expense_claim import get_payable_account
from verp.hr.doctype.expense_claim.expense_claim import make_bank_entry
from verp.hr.doctype.leave_application.leave_application import (get_leave_balance_on,
...
def get_payroll_entry():
	...
	payroll_entry.payment_account = frappe.get_value('Account', {'account_type': 'Cash', 'company': verp.get_default_company(),'is_group':0}, "name")
