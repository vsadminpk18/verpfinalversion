...
from verp.stock.doctype.serial_no.serial_no import SerialNoRequiredError, SerialNoQtyError
from verp.stock.doctype.batch.batch import UnableToSelectBatchError
...
def make_stock_reconciliation():
	...
	from verp.stock.doctype.stock_reconciliation.stock_reconciliation \
	...
	if random.random() < 0.4:
		...
		stock_reco.company = verp.get_default_company()
...
def submit_draft_stock_entries():
	from verp.stock.doctype.stock_entry.stock_entry import IncorrectValuationRateError, \
