...
from verp.accounts.doctype.payment_request.payment_request import make_payment_request, make_payment_entry
...
def make_quotation(domain):
	...
	if opportunity:
		...
		party_account_currency = get_party_account_currency("Customer", customer, verp.get_default_company())
...
def make_sales_order():
	...
	if q:
		from verp.selling.doctype.quotation.quotation import make_sales_order as mso
