...
import datetime
from verp.demo.setup.setup_data import import_json
from frappe.utils import getdate
from verp.healthcare.doctype.lab_test.lab_test import create_test_from_template
...
def import_drug():
	...
	data = json.loads(open(frappe.get_app_path('verp', 'demo', 'data', 'drug_list.json')).read())
	for d in data:
...
def get_json_path(doctype):
		return frappe.get_app_path('verp', 'demo', 'data', frappe.scrub(doctype) + '.json')
