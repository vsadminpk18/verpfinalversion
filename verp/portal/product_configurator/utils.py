...
from verp.setup.doctype.item_group.item_group import get_child_groups
...
def get_products_html_for_website(field_filters=None, attribute_filters=None):
	...
	if not items:
		html = frappe.render_template('verp/www/all-products/not_found.html', {})
...
def get_html_for_items(items):
	html = []
	for item in items:
		html.append(frappe.render_template('verp/www/all-products/item_row.html', {
			'item': item
		}))
	return html
