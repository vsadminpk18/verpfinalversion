...
from verp.payroll.doctype.salary_structure.salary_structure import make_salary_slip
from verp.payroll.doctype.payroll_entry.payroll_entry import get_month_details
from verp.hr.doctype.employee.test_employee import make_employee
from verp.hr.doctype.leave_allocation.test_leave_allocation import create_leave_allocation
from verp.hr.doctype.leave_type.test_leave_type import create_leave_type
from verp.payroll.doctype.employee_tax_exemption_declaration.test_employee_tax_exemption_declaration \
...
class TestSalarySlip(unittest.TestCase):
	...
	def test_payment_days_based_on_attendance(self):
		from verp.hr.doctype.attendance.attendance import mark_attendance
	...
	def test_payment_days(self):
		from verp.payroll.doctype.salary_structure.test_salary_structure import create_salary_structure_assignment
	...
	def test_loan_repayment_salary_slip(self):
		from verp.loan_management.doctype.loan.test_loan import create_loan_type, create_loan, make_loan_disbursement_entry, create_loan_accounts
		from verp.loan_management.doctype.process_loan_interest_accrual.process_loan_interest_accrual import process_loan_interest_accrual_for_term_loans
		from verp.payroll.doctype.salary_structure.test_salary_structure import make_salary_structure
	...
	def test_tax_for_payroll_period(self):
		...
		from verp.payroll.doctype.salary_structure.test_salary_structure import \
...
def setup_test():
	...
	frappe.db.set_value("Company", verp.get_default_company(), "default_holiday_list", "Salary Slip Test Holiday List")
