...
from verp.payroll.doctype.payroll_entry.payroll_entry import get_start_end_dates
from verp.hr.doctype.employee.employee import get_holiday_list_for_employee
from verp.utilities.transaction_base import TransactionBase
from frappe.utils.background_jobs import enqueue
from verp.payroll.doctype.additional_salary.additional_salary import get_additional_salaries
from verp.payroll.doctype.payroll_period.payroll_period import get_period_factor, get_payroll_period
from verp.payroll.doctype.employee_benefit_application.employee_benefit_application import get_benefit_component_amount
from verp.payroll.doctype.employee_benefit_claim.employee_benefit_claim import get_benefit_claim_amount, get_last_payroll_period_benefits
from verp.loan_management.doctype.loan_repayment.loan_repayment import calculate_amounts, create_repayment_entry
...
class SalarySlip(TransactionBase):
	...
	def add_leave_balances(self):
		...
		if frappe.db.get_single_value('Payroll Settings', 'show_leave_balances_in_salary_slip'):
			from verp.hr.doctype.leave_application.leave_application import get_leave_details
