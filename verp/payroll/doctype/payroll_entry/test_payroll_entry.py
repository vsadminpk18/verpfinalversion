...
from verp.payroll.doctype.payroll_entry.payroll_entry import get_start_end_dates, get_end_date
from verp.hr.doctype.employee.test_employee import make_employee
from verp.payroll.doctype.salary_slip.test_salary_slip import get_salary_component_account, \
		make_earning_salary_component, make_deduction_salary_component, create_account, make_employee_salary_slip
from verp.payroll.doctype.salary_structure.test_salary_structure import make_salary_structure, create_salary_structure_assignment
from verp.loan_management.doctype.loan.test_loan import create_loan, make_loan_disbursement_entry, create_loan_type, create_loan_accounts
...
class TestPayrollEntry(unittest.TestCase):
	@classmethod
	def setUpClass(cls):
		frappe.db.set_value("Company", verp.get_default_company(), "default_holiday_list", '_Test Holiday List')
...
def get_payment_account():
	return frappe.get_value('Account',
		{'account_type': 'Cash', 'company': verp.get_default_company(),'is_group':0}, "name")
