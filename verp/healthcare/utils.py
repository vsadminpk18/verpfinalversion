...
from verp.healthcare.doctype.healthcare_settings.healthcare_settings import get_income_account
from verp.healthcare.doctype.fee_validity.fee_validity import create_fee_validity
...
def get_appointment_type_service_item(appointment_type, department, is_inpatient):
	from verp.healthcare.doctype.appointment_type.appointment_type import get_service_item_based_on_department
