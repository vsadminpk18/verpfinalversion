...
from verp.healthcare.doctype.therapy_type.test_therapy_type import create_therapy_type
from verp.healthcare.doctype.therapy_plan.therapy_plan import make_therapy_session, make_sales_invoice
from verp.healthcare.doctype.patient_appointment.test_patient_appointment import create_healthcare_docs, create_patient, create_appointment
