...
from verp.hr.doctype.employee.employee import is_holiday
from verp.healthcare.doctype.healthcare_settings.healthcare_settings import get_receivable_account, get_income_account
from verp.healthcare.utils import check_fee_validity, get_service_item_and_practitioner_charge, manage_fee_validity
...
class PatientAppointment(Document):
	...
	def validate_service_unit(self):
		if self.inpatient_record and self.service_unit:
			from verp.healthcare.doctype.inpatient_medication_entry.inpatient_medication_entry import get_current_healthcare_service_unit
