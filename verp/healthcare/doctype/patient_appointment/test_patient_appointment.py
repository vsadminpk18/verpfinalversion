...
import unittest
import frappe
from verp.healthcare.doctype.patient_appointment.patient_appointment import update_status, make_encounter
...
class TestPatientAppointment(unittest.TestCase):
	...
	def test_appointment_booking_for_admission_service_unit(self):
		...
		from verp.healthcare.doctype.inpatient_record.test_inpatient_record import \
