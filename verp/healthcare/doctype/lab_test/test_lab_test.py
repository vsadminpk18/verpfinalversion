...
from verp.healthcare.doctype.patient_appointment.test_patient_appointment import create_patient
from verp.healthcare.doctype.lab_test.lab_test import create_multiple
from verp.healthcare.doctype.healthcare_settings.healthcare_settings import get_receivable_account, get_income_account
from verp.healthcare.doctype.patient_medical_record.test_patient_medical_record import create_lab_test_template as create_blood_test_template
