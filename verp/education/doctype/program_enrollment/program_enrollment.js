...
frappe.ui.form.on('Program Enrollment', {
	...
	onload: function(frm) {
		...
		if (frm.doc.program) {
			frm.set_query('course', 'courses', function() {
				return {
					query: 'verp.education.doctype.program_enrollment.program_enrollment.get_program_courses',
					filters: {
		...
		frm.set_query('student', function() {
			return{
				query: 'verp.education.doctype.program_enrollment.program_enrollment.get_students',
				filters: {
					'academic_year': frm.doc.academic_year,
	...
	program: function(frm) {
		...
		if (frm.doc.program) {
			frappe.call({
				method: 'verp.education.api.get_fee_schedule',
				args: {
					'program': frm.doc.program,
