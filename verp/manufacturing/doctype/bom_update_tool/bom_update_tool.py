...
from verp.manufacturing.doctype.bom.bom import get_boms_in_bottom_up_order
...
def enqueue_replace_bom(args):
	...
	frappe.enqueue("verp.manufacturing.doctype.bom_update_tool.bom_update_tool.replace_bom", args=args, timeout=40000)
	frappe.msgprint(_("Queued for replacing the BOM. It may take a few minutes."))

@frappe.whitelist()
def enqueue_update_cost():
	frappe.enqueue("verp.manufacturing.doctype.bom_update_tool.bom_update_tool.update_cost", timeout=40000)
