...
from verp.stock.get_item_details import get_conversion_factor, get_item_details
from verp.setup.utils import get_exchange_rate
from verp.accounts.utils import get_fiscal_years, validate_fiscal_year, get_account_currency
...
from verp.accounts.party import get_party_account_currency, validate_party_frozen_disabled
from verp.accounts.doctype.pricing_rule.utils import (apply_pricing_rule_on_transaction,
	apply_pricing_rule_for_free_items, get_applied_pricing_rules)
from verp.exceptions import InvalidCurrency
from six import text_type
from verp.accounts.doctype.accounting_dimension.accounting_dimension import get_accounting_dimensions
from verp.stock.get_item_details import get_item_warehouse, _get_item_tax_template, get_item_tax_map
from verp.stock.doctype.packed_item.packed_item import make_packing_list
from verp.controllers.print_settings import set_print_templates_for_item_table, set_print_templates_for_taxes
...
class AccountsController(TransactionBase):
			...
			for item in self.get("items"):
				if item.get("item_code"):
					...
					if hasattr(item, 'cost_center') and not item.get('cost_center'):
						item.set('cost_center', self.get('cost_center') or verp.get_default_cost_center(self.company))
	...
	def on_cancel(self):
		from verp.accounts.utils import unlink_ref_doc_from_payment_entries
...
def update_bin_on_delete(row, doctype):
	...
	from verp.stock.stock_balance import update_bin_qty, get_reserved_qty, get_ordered_qty, get_indented_qty
	qty_dict = {}
