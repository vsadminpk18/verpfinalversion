...
import verp
from verp.accounts.general_ledger import make_gl_entries, make_reverse_gl_entries, process_gl_map
...
class StockController(AccountsController):
	...
	def make_gl_entries(self, gl_entries=None, from_repost=False):
		...
		if cint(verp.is_perpetual_inventory_enabled(self.company)):
