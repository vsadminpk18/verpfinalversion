class ItemConfigure {
	...
	btn_add_to_cart(e) {
		...
		verp.shopping_cart.update_cart({
			item_code,
			additional_notes,
			qty: 1
		});
	...
	get_next_attribute_and_values(selected_attributes) {
		return this.call('verp.portal.product_configurator.utils.get_next_attribute_and_values', {
	...
	get_attributes_and_values() {
		return this.call('verp.portal.product_configurator.utils.get_attributes_and_values', {
			item_code: this.item_code
		});
	}
