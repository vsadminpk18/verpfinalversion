...
// shopping cart
frappe.provide("verp.shopping_cart");
var shopping_cart = verp.shopping_cart;
...
$.extend(shopping_cart, {
	...
	apply_shipping_rule: function(rule, btn) {
		return frappe.call({
			btn: btn,
			type: "POST",
			method: "verp.shopping_cart.cart.apply_shipping_rule",
	...
	place_order: function(btn) {
		return frappe.call({
			type: "POST",
			method: "verp.shopping_cart.cart.place_order",
			btn: btn,
			callback: function(r) {
				if(r.exc) {
					var msg = "";
	...
	request_quotation: function(btn) {
		return frappe.call({
			type: "POST",
			method: "verp.shopping_cart.cart.request_for_quotation",
			btn: btn,
			callback: function(r) {
				if(r.exc) {
					var msg = "";
	...
	apply_coupon_code: function(btn) {
		return frappe.call({
			type: "POST",
			method: "verp.shopping_cart.cart.apply_coupon_code",
			btn: btn,
			args : {
