...
from verp.loan_management.doctype.loan_security_shortfall.loan_security_shortfall import update_shortfall_status
...
from verp.loan_management.doctype.loan_interest_accrual.loan_interest_accrual import get_per_day_interest, get_last_accrual_date
...
class LoanRepayment(AccountsController):
	...
	def set_missing_values(self, amounts):
		...
		if not self.cost_center:
			self.cost_center = verp.get_default_cost_center(self.company)
