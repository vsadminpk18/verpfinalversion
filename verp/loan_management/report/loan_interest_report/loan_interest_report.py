...
from verp.loan_management.report.applicant_wise_loan_security_exposure.applicant_wise_loan_security_exposure \
...
def get_active_loan_details(filters):
	...
	currency = verp.get_company_currency(filters.get('company'))
