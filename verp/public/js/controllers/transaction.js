...
verp.TransactionController = class TransactionController extends verp.taxes_and_totals {
	...
	scan_barcode() {
		...
		if(this.frm.doc.scan_barcode) {
			frappe.call({
				method: "verp.selling.page.point_of_sale.point_of_sale.search_for_serial_or_batch_or_barcode_number",
...
verp.show_serial_batch_selector = function (frm, d, callback, on_close, show_dialog) {
