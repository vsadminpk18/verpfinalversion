...
{% include 'verp/accounts/doctype/purchase_taxes_and_charges_template/purchase_taxes_and_charges_template.js' %}
		...
		if(this.frm.get_field('shipping_address')) {
			this.frm.set_query("shipping_address", function() {
				if(me.frm.doc.customer) {
					...
					return verp.queries.company_address_query(me.frm.doc)
			});
		}
		/* eslint-enable */
	}
	...
	setup_queries(doc, cdt, cdn) {
		...
		if(this.frm.fields_dict.supplier) {
			this.frm.set_query("supplier", function() {
				return{	query: "verp.controllers.queries.supplier_query" }});
		}
