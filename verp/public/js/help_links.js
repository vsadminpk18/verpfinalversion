...
frappe.help.help_links["Form/PayPal Settings"] = [
	{
		...
		url:
			docsUrl +
			"user/manual/en/verp_integration/paypal-integration",
	},
];
...
frappe.help.help_links["Form/Razorpay Settings"] = [
	{
		...
		url:
			docsUrl +
			"user/manual/en/verp_integration/razorpay-integration",
	},
];
...
frappe.help.help_links["Form/Dropbox Settings"] = [
	{
		...
		url: docsUrl + "user/manual/en/verp_integration/dropbox-backup",
	},
];
...
frappe.help.help_links["Form/LDAP Settings"] = [
	{
		label: "LDAP Settings",
		url:
			docsUrl + "user/manual/en/verp_integration/ldap-integration",
	},
];
...
frappe.help.help_links["Form/Stripe Settings"] = [
	{
		...
		url:
			docsUrl +
			"user/manual/en/verp_integration/stripe-integration",
	},
];
...
frappe.help.help_links["Form/Customize Form"] = [
	{
		label: "Custom Field",
		url: docsUrl + "user/manual/en/customize-verp/custom-field",
	},
	{
		label: "Customize Field",
		url: docsUrl + "user/manual/en/customize-verp/customize-form",
	},
];
