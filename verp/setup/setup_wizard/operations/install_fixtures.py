...
def install(country=None):
	...
	from verp.setup.setup_wizard.data.industry_type import get_industry_types
...
def add_uom_data():
	# add UOMs
	uoms = json.loads(open(frappe.get_app_path("verp", "setup", "setup_wizard", "data", "uom_data.json")).read())
	for d in uoms:
	...
	uom_conversions = json.loads(open(frappe.get_app_path("verp", "setup", "setup_wizard", "data", "uom_conversion_data.json")).read())
