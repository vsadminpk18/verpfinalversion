...
import frappe
from verp.accounts.doctype.cash_flow_mapper.default_cash_flow_mapper import DEFAULT_MAPPERS
	...
	verp_navbar_items = [
		{
			...
			'item_type': 'Route',
			'route': 'https://verp.com/docs/user/manual',
			'is_standard': 1
		},
		{
			'item_label': 'User Forum',
			'item_type': 'Route',
			'route': 'https://discuss.verp.com',
			'is_standard': 1
		},
		{
...
def add_app_name():
	frappe.db.set_value('System Settings', None, 'app_name', 'VERP')
