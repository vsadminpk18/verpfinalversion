...
from verp.exceptions import PartyFrozen, PartyDisabled, InvalidAccountCurrency
...
def set_taxes(party, party_type, posting_date, company, customer_group=None, supplier_group=None, tax_category=None,
	...
	from verp.accounts.doctype.tax_rule.tax_rule import get_tax_template, get_party_details
	args = {
		party_type.lower(): party,
		"company": company
	}
