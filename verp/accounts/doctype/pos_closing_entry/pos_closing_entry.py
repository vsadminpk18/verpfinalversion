...
from verp.accounts.doctype.pos_invoice_merge_log.pos_invoice_merge_log import consolidate_pos_invoices, unconsolidate_pos_invoices
...
class POSClosingEntry(StatusUpdater):
	...
	def get_payment_reconciliation_details(self):
		...
		return frappe.render_template("verp/accounts/doctype/pos_closing_entry/closing_voucher_details.html",
