...
import unittest
import frappe
from verp.stock import get_warehouse_account, get_company_default_inventory_account
from verp.accounts.doctype.account.account import update_account_number, merge_account
