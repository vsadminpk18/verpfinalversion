...
from verp.stock.doctype.stock_entry.test_stock_entry import make_stock_entry, get_qty_after_transaction
from verp.accounts.doctype.purchase_invoice.test_purchase_invoice import unlink_payment_on_cancel_of_invoice
...
from verp.stock.doctype.serial_no.serial_no import SerialNoWarehouseError
from frappe.model.naming import make_autoname
from verp.accounts.doctype.account.test_account import get_inventory_account, create_account
...
from verp.regional.india.utils import get_ewb_data
...
class TestSalesInvoice(unittest.TestCase):
	...
	def test_payment(self):
		...
		from verp.accounts.doctype.journal_entry.test_journal_entry \
	...
	def _insert_purchase_receipt(self):
		from verp.stock.doctype.purchase_receipt.test_purchase_receipt import test_records \
			as pr_test_records
	...
	def _insert_delivery_note(self):
		from verp.stock.doctype.delivery_note.test_delivery_note import test_records \
			as dn_test_records
	...
	def test_sales_invoice_with_shipping_rule(self):
		from verp.accounts.doctype.shipping_rule.test_shipping_rule \
	...
	def test_einvoice_json(self):
		from verp.regional.india.e_invoice.utils import make_einvoice, validate_totals
