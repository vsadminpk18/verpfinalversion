...
{% include 'verp/selling/sales_common.js' %};
frappe.provide("verp.accounts");


verp.accounts.SalesInvoiceController = class SalesInvoiceController extends verp.selling.SellingController {
	setup(doc) {
	...
	customer() {
		...
		verp.utils.get_party_details(this.frm,
...
frappe.ui.form.on('Sales Invoice Timesheet', {
	time_sheet: function(frm, cdt, cdn){
		...
		if(d.time_sheet) {
			frappe.call({
				method: "verp.projects.doctype.timesheet.timesheet.get_timesheet_data",
				args: {
					'name': d.time_sheet,
...
var get_healthcare_services_to_invoice = function(frm) {
	...
	dialog.fields_dict["patient"].df.onchange = () => {
		...
		if(patient && patient!=selected_patient){
			...
			var method = "verp.healthcare.utils.get_healthcare_services_to_invoice";
...
var get_drugs_to_invoice = function(frm) {
	...
	dialog.fields_dict["encounter"].df.onchange = () => {
		...
		if(encounter && encounter!=selected_encounter){
			...
			var method = "verp.healthcare.utils.get_drugs_to_invoice";
