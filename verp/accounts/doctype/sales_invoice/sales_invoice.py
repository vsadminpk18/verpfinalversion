...
from verp.accounts.party import get_party_account, get_due_date, get_party_details
...
from verp.assets.doctype.asset.depreciation \
	import get_disposal_account_and_cost_center, get_gl_entries_on_asset_disposal, get_gl_entries_on_asset_regain
from verp.stock.doctype.batch.batch import set_batch_nos
from verp.stock.doctype.serial_no.serial_no import get_serial_nos, get_delivery_note_serial_no
...
from verp.healthcare.utils import manage_invoice_submit_cancel
...
class SalesInvoice(SellingController):
	...
	def set_pos_fields(self, for_validate=False):
		...
		from verp.stock.get_item_details import get_pos_profile_item_details, get_pos_profile
	...
	def make_item_gl_entries(self, gl_entries):
		...
		if cint(self.update_stock) and \
			verp.is_perpetual_inventory_enabled(self.company):
	...
	def apply_loyalty_points(self):
		from verp.accounts.doctype.loyalty_point_entry.loyalty_point_entry \
...
def create_dunning(source_name, target_doc=None):
	from frappe.model.mapper import get_mapped_doc
	from verp.accounts.doctype.dunning.dunning import get_dunning_letter_text, calculate_interest_and_amount
	def set_missing_values(source, target):
