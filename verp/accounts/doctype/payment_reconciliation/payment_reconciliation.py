...
from verp.accounts.utils import (get_outstanding_invoices,
	update_reference_in_payment_entry, reconcile_against_document)
from verp.controllers.accounts_controller import get_advance_payment_entries
...
class PaymentReconciliation(Document):
	...
	def get_jv_entries(self):
		dr_or_cr = ("credit_in_account_currency" if verp.get_party_account_type(self.party_type) == 'Receivable'
	...
	def get_dr_or_cr_notes(self):
		dr_or_cr = ("credit_in_account_currency"
			if verp.get_party_account_type(self.party_type) == 'Receivable' else "debit_in_account_currency")
	...
	def check_condition(self):
		...
		dr_or_cr = ("debit_in_account_currency" if verp.get_party_account_type(self.party_type) == 'Receivable'
