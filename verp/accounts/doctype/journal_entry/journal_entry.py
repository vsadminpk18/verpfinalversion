...
from verp.accounts.utils import get_balance_on, get_stock_accounts, get_stock_and_account_balance, \
...
from verp.accounts.doctype.invoice_discounting.invoice_discounting \
...
class JournalEntry(AccountsController):
	...
	def on_cancel(self):
		...
		from verp.payroll.doctype.salary_slip.salary_slip import unlink_ref_doc_from_salary_slip
