...
import frappe, verp, json
from frappe import _, scrub, ValidationError, throw
from frappe.utils import flt, comma_or, nowdate, getdate, cint
from verp.accounts.utils import get_outstanding_invoices, get_account_currency, get_balance_on
...
from verp.hr.doctype.expense_claim.expense_claim import update_reimbursed_amount
from verp.accounts.doctype.bank_account.bank_account import get_party_bank_account, get_bank_account_details
from verp.controllers.accounts_controller import AccountsController, get_supplier_block_status
from verp.accounts.doctype.invoice_discounting.invoice_discounting import get_party_account_based_on_invoice_discounting
from verp.accounts.doctype.tax_withholding_category.tax_withholding_category import get_party_tax_withholding_details
from six import string_types, iteritems

from verp.controllers.accounts_controller import validate_taxes_and_charges
...
class PaymentEntry(AccountsController):
		...
		if self.party:
			...
			if self.party_account and self.party_type in ("Customer", "Supplier"):
				self.validate_account_type(self.party_account,
					[verp.get_party_account_type(self.party_type)])
	...
	def add_party_gl_entries(self, gl_entries):
		if self.party_account:
			...
			dr_or_cr = "credit" if verp.get_party_account_type(self.party_type) == 'Receivable' else "debit"
