...
from verp.accounts.report.financial_statements import (get_period_list, get_columns, get_data)
...
def _get_account_type_based_data(filters, account_names, period_list, accumulated_values, opening_balances=0):
	from verp.accounts.report.cash_flow.cash_flow import get_start_date
