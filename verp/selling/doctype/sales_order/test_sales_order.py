...
from verp.selling.doctype.sales_order.sales_order import make_work_orders
from verp.controllers.accounts_controller import update_child_qty_rate
from verp.selling.doctype.sales_order.sales_order import make_raw_material_request
...
class TestSalesOrder(unittest.TestCase):
	...
	def test_drop_shipping(self):
		from verp.selling.doctype.sales_order.sales_order import make_purchase_order_for_default_supplier, \
	...
	def test_serial_no_based_delivery(self):
		...
		so.submit()
		from verp.manufacturing.doctype.work_order.test_work_order import \
