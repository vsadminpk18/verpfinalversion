...
from verp.non_profit.doctype.membership.membership import verify_signature
...
def notify_failure(log):
	try:
		...
		sendmail_to_system_managers(_('[Important] [VERP] Razorpay donation webhook failed, please check.'), content)
	except Exception:
		pass
