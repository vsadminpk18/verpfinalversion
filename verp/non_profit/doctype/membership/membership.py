...
class Membership(Document):
	...
	def validate_membership_period(self):
		...
		last_membership = verp.get_last_membership(self.member)
...
def get_company_for_memberships():
	...
	if not company:
		from verp.healthcare.setup import get_company
		company = get_company()
	return company
...
def notify_failure(log):
	try:
		...
		sendmail_to_system_managers("[Important] [VERP] Razorpay membership webhook failed , please check.", content)
	except:
		pass
