...
def send_reminder():
	...
	frappe.enqueue('verp.regional.doctype.gst_settings.gst_settings.send_gstin_reminder_to_all_parties')
...
def _send_gstin_reminder(party_type, party, default_email_id=None, sent_to=None):
	...
	frappe.sendmail(
		...
		<p style="color: #aaa; font-size: 11px; margin-top: 30px;">
			Get your GST Ready ERP system at <a href="https://verp.com">https://verp.com</a>
			<br>
			VERP is a free and open source ERP system.
		</p>
