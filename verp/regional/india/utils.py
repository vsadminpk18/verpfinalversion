...
from verp.regional.india import states, state_numbers
from verp.controllers.taxes_and_totals import get_itemised_tax, get_itemised_taxable_amount
from verp.controllers.accounts_controller import get_taxes_and_charges
from verp.hr.utils import get_salary_assignment
from verp.payroll.doctype.salary_structure.salary_structure import make_salary_slip
from verp.regional.india import number_state_mapping
	...
	if doc.reverse_charge == 'Y':
		...
		if base_gst_tax != base_reverse_charge_booked:
			...
			msg += _("Please refer {gst_document_link} to learn more about how to setup and create reverse charge invoice").format(
				gst_document_link='<a href="https://docs.verp.com/docs/user/manual/en/regional/india/gst-setup">GST Documentation</a>')
