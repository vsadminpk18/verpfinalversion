...
from verp.regional.india import states
from verp.accounts.utils import get_fiscal_year, FiscalYearError
...
def setup_company_independent_fixtures(patch=False):
	...
	frappe.enqueue('verp.regional.india.setup.add_hsn_sac_codes', now=frappe.flags.in_test)
