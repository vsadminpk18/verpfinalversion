...
import unittest, frappe, requests, os, time, verp
from verp.verp_integrations.connectors.woocommerce_connection import order
...
def emulate_request():
	...
	url = "http://{site}:{port}/api/method/verp.verp_integrations.connectors.woocommerce_connection.order".format(site=host, port=port)
