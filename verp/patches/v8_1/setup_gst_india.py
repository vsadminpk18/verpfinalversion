...
def execute():
	...
	from verp.regional.india.setup import setup
...
<p>Please refer {gst_document_link} to know more about how to setup and implement GST in VERP.</p>

<p>Please contact us at support@verp.com, if you have any questions.</p>

<p>Thanks,</p>
VERP Team.
	""".format(gst_document_link="<a href='http://frappe.github.io/verp/user/manual/en/regional/india/'> VERP GST Document </a>")

	try:
		sendmail_to_system_managers("[Important] VERP GST updates", message)
