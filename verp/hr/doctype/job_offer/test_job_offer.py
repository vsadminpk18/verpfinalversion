...
from verp.hr.doctype.job_applicant.test_job_applicant import create_job_applicant
from verp.hr.doctype.designation.test_designation import create_designation
from verp.hr.doctype.staffing_plan.test_staffing_plan import make_company
