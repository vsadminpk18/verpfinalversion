...
from verp.hr.doctype.employee_advance.employee_advance import make_bank_entry
from verp.hr.doctype.employee_advance.employee_advance import EmployeeAdvanceOverPayment
