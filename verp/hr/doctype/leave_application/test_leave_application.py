...
from verp.hr.doctype.leave_application.leave_application import LeaveDayBlockedError, OverlapError, NotAnOptionalHoliday, get_leave_balance_on
...
from verp.hr.doctype.leave_policy_assignment.leave_policy_assignment import create_assignment_for_multiple_employees
...
class TestLeaveApplication(unittest.TestCase):
	...
	def test_earned_leaves_creation(self):
		...
		from verp.hr.utils import allocate_earned_leaves
		i = 0
		while(i<14):
