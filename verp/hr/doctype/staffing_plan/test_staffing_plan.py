...
import frappe
import unittest
from verp.hr.doctype.staffing_plan.staffing_plan import SubsidiaryCompanyError
from verp.hr.doctype.staffing_plan.staffing_plan import ParentCompanyError
