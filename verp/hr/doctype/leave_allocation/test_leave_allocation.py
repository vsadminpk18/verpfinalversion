...
from verp.hr.doctype.leave_ledger_entry.leave_ledger_entry import process_expired_allocation, expire_allocation
class TestLeaveAllocation(unittest.TestCase):
	...
	def test_against_leave_application_validation_after_submit(self):
		...
		leave_application = frappe.get_doc({
			...
			"company": verp.get_default_company() or "_Test Company",
			"docstatus": 1,
			"status": "Approved",
